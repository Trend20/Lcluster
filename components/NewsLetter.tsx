...
const NewsLatter = () => {
    ...
    return (
        <div className="relative z-10 rounded-sm border p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
            ...
            <div>
                ...
                <input
                    type="submit"
                    value="Subscribe"
                    className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-teal px-9 py-4 text-base font-medium shadow-submit duration-300 dark:shadow-submit-dark"
                />
