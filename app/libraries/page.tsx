...
const LibrariesPage = async () => {
    ...
    return (
        <div
            className="flex flex-col mt-20 w-full px-4 md:px-6 lg:px-36 py-10 md:py-16 lg:py-24 justify-center items-center">
            ...
            <div
                className="grid w-full grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-8 py-8 md:py-10 lg:py-12">
